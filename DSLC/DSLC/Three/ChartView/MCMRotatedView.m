...
@interface MCMRotatedView()
@property (nonatomic,assign) NSInteger selectedIndex;
- (void)timerStop;
- (void)tapStopped;
- (void)decelerate;
@property (strong, nonatomic) MCMRenderView *pieChart;
@property (nonatomic, assign) BOOL canLayerOpen;
@end

@implementation MCMRotatedView
...
- (id)initWithFrame:(CGRect)frame {
    if ((self = [super initWithFrame:frame])) {
        ...
        self.pieChart = [[MCMRenderView alloc]initWithFrame:CGRectMake(0, 0, frame.size.width, frame.size.height)];
