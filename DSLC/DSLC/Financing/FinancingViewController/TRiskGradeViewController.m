...
- (void)viewDidLoad {
    ...
    styleArr = @[@"产品等级", @"R1   (保守型)", @"R2   (稳健性)", @"R3   (平衡型)", @"R4   (成长型)", @"R5   (进取型)"];
...
- (void)tableViewShow
{
    ...
    UIButton *butonPing = [CreatView creatWithButtonType:UIButtonTypeCustom frame:CGRectMake(40, 85, WIDTH_CONTROLLER_DEFAULT - 80, 40) backgroundColor:[UIColor greenColor] textColor:[UIColor whiteColor] titleText:@"立即测评"];
