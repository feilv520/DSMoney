...
- (void)tableViewShow
{
    ...
    contentArr = @[@[@"1、活动期间，新注册用户自动获取“5000个体验金”（1个体验金价值1元人民币）。\n\n2、“5000个体验金”只能用于体验“新手专享”，客户无需支付任何本金，到期即可获得活动收益。\n\n3、“新手专享”产品是为活动设定的虚拟借款产品，不对接真实借款人，其对应的法律文件均系为用户提供更真实的投资体验，无实际法律效力。\n\n 4、“体验金”是大圣理财平台开发的会员优惠，不具备货币功能。\n\n5、“5000个体验金”自新用户获得之日起有效，须一次性使用完。产品到期后该5000体验金由平台收回。\n\n6、到期收益如须提现，请先实名认证并绑定银行卡。\n\n7、恶意刷体验金、冒用他人身份信息使用体验金等行为（包括但不限于手机号码、身份证、IP等信息），一经核实，平台有权收回该用户所得体验金及收益，并冻结账户。\n\n8、 *活动最终解释权归国丞创投（上海）金融信息服务有限公司（大圣理财平台）所有，如您有任何疑问，请致电400-816-2283"],
