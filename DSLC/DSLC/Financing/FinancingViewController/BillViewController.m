...
//固收活动展示
- (void)activityShowGuShou
{
    imageActivit = [CreatView creatImageViewWithFrame:CGRectMake(0, 0, WIDTH_CONTROLLER_DEFAULT, 100) backGroundColor:[UIColor whiteColor] setImage:[UIImage imageNamed:@"shouyebanner"]];
