...
- (void)contentShow
{
    ...
    UITextField *textField = [CreatView creatWithfFrame:CGRectMake(WIDTH_CONTROLLER_DEFAULT * (110.0 / 375.0), HEIGHT_CONTROLLER_DEFAULT * (60.0 / 667.0), WIDTH_CONTROLLER_DEFAULT - WIDTH_CONTROLLER_DEFAULT * (120.0 / 375.0), 30) setPlaceholder:@"充值金额最小为1元" setTintColor:[UIColor grayColor]];
    [self.view addSubview:textField];
    textField.font = [UIFont fontWithName:@"CenturyGothic" size:14];
