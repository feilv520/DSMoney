...
- (void)contentShow
{
    ...
    ContentArr = @[@[@"新鲜花生最好连壳煮着吃，煮熟后的花生不仅容易消化吸收，而且可以充分利用花生壳和内层红衣的医疗保健作用。花    生红衣能抑制纤维蛋白的溶解，促进血小板新生，加强毛细血管的收缩功能，可治疗血小板减少和防治出血性疾病；花生壳有降低血压、调整胆固醇的作用。古籍认为，花生补中益气，盐水煮食养肺。"],
                   @[@"有些人习惯吃炒花仁或用油炸后吃，这样会使花生红衣中所合甘油脂和塞醇酯成分被大量破坏，因此花生仁连红衣一起煮着吃营养价值更高。另外，花生容易感染黄曲霉菌毒素，水煮后，花生所污染的黄曲霉菌毒素基本上能溶到水里去，这样吃更安全。花生米含有人体所需要的不饱和脂肪酸，但毕竟脂类含量高、热量大、有油腻感。而醋中的多种有机酸恰是解腻又生香的，因此用醋浸泡花生米一周以上，每晚吃7到10粒，连吃一周为一个疗程，可降低血压，软化血管，减少胆固醇的堆积。"], @[@"花生中高含量的蛋白及氨基酸还可提高记忆力，延缓衰老。它所含的VE可延缓组织老化，并增强肝脏解毒功能。"]];
}
