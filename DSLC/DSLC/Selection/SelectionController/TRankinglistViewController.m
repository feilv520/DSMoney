...
@implementation TRankinglistViewController
...
//    NSString * title = [webView stringByEvaluatingJavaScriptFromString:@"document.header.a"];//获取当前页面的title
//    self.title = title;
//    
//    NSLog(@"%@",self.title);
}
